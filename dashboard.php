Tentu, saya akan memindahkan bagian "Biaya Keselamatan" (termasuk *query* PHP dan *script* JavaScript-nya) agar berada tepat di bawah tiga *chart* pendapatan dan beban di dashboard Anda.

Berikut adalah kode `dashboard.php` yang telah dimodifikasi:
...
// Query total realisasi and anggaran for Biaya Keselamatan (MOVED HERE)
...
// Query consumption per unit for Biaya Keselamatan (MOVED HERE)
...
// Calculate percentage for display (MOVED HERE)
